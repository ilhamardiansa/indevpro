      ...
      <div class="container-fluid">
            <div class="row">
                ...
                <?php if(!$member){
                  ...
                  DAFTAR MEMBER DAHULU SEBELUM MEMINJAM BUKU. <a href="'.$link.'/verifikasi" class="alert-link">DISINI</a>
  </div>';
                  ...
                  <?= $this->session->flashdata('message') ?>
                    <form action="<?php echo 'dashboard/search' ?>" method="post">
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name() ?>" value="<?php echo $this->security->get_csrf_hash() ?>" readonly>
                        <div class="input-group">
                            <input type="search" name="keyword" class="form-control form-control-lg" placeholder="Cari buku....">
