              ...
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name() ?>" value="<?php echo $this->security->get_csrf_hash() ?>" readonly>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="title buku">
                  </div>
                  <?= form_error('title'); ?>
                  <div class="form-group">
                  <label>author</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="year" name="year" placeholder="tahun keluar buku">
                  </div>
                  <?= form_error('year'); ?>
                  <div class="form-group">
